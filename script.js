...
const quizData = [
    ...
    { question: "Khi hệ thống có một quy trình xét duyệt chứa rất nhiều điều kiện rẽ nhánh phức tạp (Business Rules), kỹ thuật/công cụ nào BA nên dùng để mô tả logic rõ ràng nhất cho Developer?", options: ["Use Case Diagram", "Decision Table (Bảng quyết định) / Decision Tree", "Entity Relationship Diagram (ERD)", "Wireframe / Mockup"], correct: 1 },
    { question: "Trong dự án tích hợp hệ thống (ví dụ: Mobile App gọi API của Core Banking), tài liệu/đặc tả nào BA cần chú trọng nhất để mô tả luồng dữ liệu truyền nhận?", options: ["Business Requirements Document (BRD)", "API Data Mapping Document / Data Dictionary", "User Manual (Tài liệu HDSD)", "User Interface (UI) Guideline"], correct: 1 },
    { question: "Yêu cầu: 'Hệ thống chuyển tiền NAPAS phải có khả năng xử lý đồng thời 10,000 giao dịch/giây với độ trễ dưới 2 giây' thuộc nhóm yêu cầu nào?", options: ["Functional Requirement (Yêu cầu chức năng)", "Business Requirement (Yêu cầu nghiệp vụ)", "Non-functional Requirement (Yêu cầu phi chức năng)", "Transition Requirement (Yêu cầu chuyển đổi)"], correct: 2 },
    { question: "Trong quản lý dự án Agile/Scrum, nếu BA và team nhận thấy một User Story có khối lượng công việc (estimate) quá lớn và không thể hoàn thành trong 1 Sprint, cách xử lý chuẩn xác nhất là gì?", options: ["Kéo dài thời gian của Sprint để cố gắng làm cho xong", "Bỏ qua và chuyển toàn bộ User Story đó sang Sprint tiếp theo", "Phân tách (Split) User Story đó thành các Story nhỏ hơn (đảm bảo mỗi Story có thể test độc lập)", "Cắt bớt Acceptance Criteria và vội vàng đưa lên Production"], correct: 2 },
    { question: "Kỹ thuật nào thường được BA áp dụng đầu tiên để đào sâu, tìm ra 'nguyên nhân cốt lõi' của một vấn đề kinh doanh trước khi đề xuất giải pháp hệ thống sửa lỗi?", options: ["Root Cause Analysis (Kỹ thuật 5 Whys / Biểu đồ xương cá)", "SWOT Analysis (Phân tích điểm mạnh, điểm yếu)", "Prototyping (Làm bản nháp thiết kế màn hình)", "Data Modeling (Mô hình hóa dữ liệu)"], correct: 0 }
];
